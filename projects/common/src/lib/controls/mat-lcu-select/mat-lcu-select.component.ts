...
// export function validateValue(c: FormControl) {
//   let err = {
//     rangeError: {
//       given: c.value,
//       max: 10,
...
@Component({
  selector: 'lcu-mat-lcu-select',
  templateUrl: './mat-lcu-select.component.html',
  styleUrls: ['./mat-lcu-select.component.scss'],
  /**
  ...
  providers: [{
    ...
    useExisting: forwardRef(() => MatLcuSelectComponent),
    multi: true,
  }
  ]
})

export class MatLcuSelectComponent implements OnInit, ControlValueAccessor {
